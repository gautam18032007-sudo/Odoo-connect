...
import { BarChart3, LayoutGrid, ListFilter, RefreshCw, Table as TableIcon, Upload } from "lucide-react";
...
export default function Page() {
			...
			<div className="flex flex-col items-center justify-center min-h-[60vh] p-4 text-center space-y-6">
				...
				<div className="max-w-md space-y-2">
					...
					<p className="text-muted-foreground">
						No sales or deal data uploaded yet. Upload your daily sales sheet or hook Odoo webhooks.
					</p>
				</div>
	...
	const leadsList = crmData?.leads && crmData.leads.length > 0
		? crmData.leads
		: (data?.recentOrders || []).map((ord: any, idx: number) => ({
				...
				stage: idx % 5 === 4 ? "Closed Won" : idx % 5 === 0 ? "Qualified" : idx % 5 === 1 ? "Discovery" : idx % 5 === 2 ? "Proposal Sent" : "Negotiation",
