...
async function main() {
	...
	console.log("\n=======================================================");
	console.log(
		"=== CHECKING 01 AUG 2026 IST IN FACT_SALES_ORDERS BY IST DATE ===",
	);
	console.log("=======================================================\n");

	const resRange = await sql`
		SELECT 
		...
		WHERE date_order >= '2026-07-31 18:30:00+00' AND date_order <= '2026-08-01 18:29:59+00'
		  AND state IN ('paid', 'done', 'invoiced')
	`;
	console.log(
		"Orders queried by UTC timestamp range corresponding to 01 Aug 2026 IST:",
	);
	console.table(resRange);
